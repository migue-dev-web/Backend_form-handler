    ...
    try:
        ...
        for prog in programaciones_apertura:
            ...
            for usuario in usuarios:
                ...
                html = f'    <div style="background-color: #f9f9f9; padding: 40px 20px; font-family: Arial, sans-serif;"><div style="color:#ffff ;max-width: 500px; margin: 0 auto; background-color: #ffffff; border-radius: 12px; border: 1px solid #e0e0e0; box-shadow: 0 4px 6px rgba(0,0,0,0.05); overflow: hidden; display: flex; align-items: center; justify-content: center;"> <div style="background: linear-gradient(to right, #2ec4e6, #1e5fa5)"><div style="padding: 1%; width: 100%; color: #ffff; height: 20px; background:#1e5fa5; display: flex; align-items: center; justify-content: center;"><h3>¡Hola, {usuario.nombre}!</h3></div><br><div style="padding: 1%; width: 100%; height: 20px;  display: flex; align-items: center; justify-content: center;"><p>El formulario <b>{form.nombre}</b> ya está disponible para su llenado.</p></div> <br><div style="padding: 1%; width: 100%; height: 20px;  display: flex; align-items: center; justify-content: center;"><p><b>Recuerde:</b> el formulario cierra: {prog.fecha_fin}, Esperamos sus respuestas </p></div><br><div style="padding: 1%; width: 100%; height: 20px;  display: flex; align-items: center; justify-content: center;"><h2>Gracias</h2></div></div></div></div>'
        ...
        for prog in programaciones_cierre:
            ...
            for usuario in usuarios:
                html = f'<div style="background-color: #f9f9f9; padding: 40px 20px; font-family: Arial, sans-serif;"><div style="color:#ffff ;max-width: 500px; margin: 0 auto; background-color: #ffffff; border-radius: 12px; border: 1px solid #e0e0e0; box-shadow: 0 4px 6px rgba(0,0,0,0.05); overflow: hidden; display: flex; align-items: center; justify-content: center;"> <div style="padding: 10px;background: linear-gradient(to right, #2ec4e6, #1e5fa5)"><div style="padding: 1%; width: 100%; color: #ffff; height: 20px; background:#1e5fa5; display: flex; align-items: center; justify-content: center;"><h3>Recordatorio Urgente</h3></div><br><div style="padding: 1%; width: 100%; height: 20px;  display: flex; align-items: center; justify-content: center;"><p>El formulario {form.nombre} cerrará pronto: {prog.fecha_fin}. Por favor, complétalo.</p></div><br><div style="padding: 1%; width: 100%; height: 20px;  display: flex; align-items: center; justify-content: center;"><h2>Gracias</h2></div></div></div></div>'
